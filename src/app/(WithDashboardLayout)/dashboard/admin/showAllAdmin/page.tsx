...
import { Users, UserCheck, Calendar, Mail, User, Trash2, Search, Crown, Shield, Activity, Filter } from 'lucide-react'
...
export default function ShowAllAdminPage() {
  ...
  useEffect(() => {
    ...
    // Sort admins - fix type errors
    filtered.sort((a, b) => {
      let aValue: string | number
      let bValue: string | number

      // Only allow sorting by 'name', 'email', or 'createdAt'
      if (sortBy === 'createdAt') {
