...
export default function TempDashboardPage() {
    ...
    return (
      <div className="min-h-screen w-full bg-white flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-gray-900 mb-4">No Dashboard ID</h1>
          <p className="text-gray-600 mb-6">No dashboard ID provided for live preview.</p>
  ...
  if (isLoading && tempScreens.length === 0) {
    return (
      <div className="min-h-screen w-full bg-white flex items-center justify-center">
        <div className="text-center">
          <SpinningBellLoader />
          <p className="mt-4 text-gray-600">Loading live preview...</p>
        </div>
      </div>
    )
  }
  ...
  if (tempScreens.length === 0) {
    return (
      <div className="min-h-screen w-full bg-white flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-gray-900 mb-4">No Live Data</h1>
          <p className="text-gray-600 mb-6">No live dashboard data available. Make changes in the editor to see live updates.</p>
          <Link href="/dashboard/layout/edit-dashboard">
            <Button>Back to Editor</Button>
          </Link>
        </div>
      ...
      <div className="bg-white border-b border-gray-200 px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            <Link href="/dashboard/layout/edit-dashboard" className="flex items-center space-x-2 text-gray-600 hover:text-gray-900 transition-colors">
              <ArrowLeft size={20} />
              <span>Back to Editor</span>
            </Link>
            <div className="h-6 w-px bg-gray-300"></div>
            <h1 className="text-xl font-semibold text-gray-900">Live Dashboard Preview</h1>
          </div>
              ...
              <div className="bg-gray-800 text-white px-4 py-2 flex justify-between items-center">
                <div>
                  <span className="font-semibold">
                    {currentScreen.screenName || `Screen ${typeof currentScreen.screenIndex === "number" ? currentScreen.screenIndex + 1 : currentScreenIndex + 1}`}
                  </span>
